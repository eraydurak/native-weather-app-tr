...
const openWeatherKey = `efbcb927e7222db0fb6a42d350f400aa`;
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView
        refreshControl={
          ...
          />}
      >
        <Text style={styles.title}>Güncel Hava Durumu</Text>
        <Text style={{ alignItems: 'center', textAlign: 'center' }}>BURSA</Text>
        ...
        <View style={styles.extraInfo}>
          <View style={styles.info}>
            ...
            <Text style={{ fontSize: 20, color: 'white', textAlign: 'center' }}>Hissedilen</Text>
          </View>
          <View style={styles.info}>
            <Image
            ...
            <Text style={{ fontSize: 20, color: 'white', textAlign: 'center' }}>Nem</Text>
          </View>
        </View>

        <View>
          <Text style={styles.subtitle}>Saatlik Hava Durumu</Text>
          <FlatList horizontal
